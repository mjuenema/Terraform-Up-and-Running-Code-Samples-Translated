...
This folder contains an example [Terraform](https://www.terraform.io/) template that deploys a single web server 
(using [Google Compute Engine](https://cloud.google.com/compute/) in a [Google Cloud Platform](https://cloud.google.com) account.
The web server listens on port 8080 (which is defined as a variable in this example) and returns the text "Hello, World" for the `/` URL.
